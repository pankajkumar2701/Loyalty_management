...
using Loyaltymanagement.Services;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Loyaltymanagement", Version = "v1" });
...
builder.Services.AddTransient<LoyaltymanagementContext>();
